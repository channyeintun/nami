...
| Phase 5 compaction and cache        | in progress | M     | Session-local memoization for system prompt sections is landed; output slot reservation and provider-gated cache stability remain.                                                                                                                                   |
