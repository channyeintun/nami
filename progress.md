...
| Phase 5 compaction and cache        | in progress | M     | Session-local prompt memoization, adaptive output slot reservation, shared context-pressure policy, and provider-gated cache-stable prompt ordering are landed.                                                                                                      |
