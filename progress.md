...
| Phase 5 compaction and cache        | in progress | M     | Session-local prompt memoization, adaptive output slot reservation, and a shared context-pressure policy for compaction vs. memory recall are landed; provider-gated cache stability remains.                                                                        |
