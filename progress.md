...
| Phase 5 compaction and cache        | in progress | M     | Session-local prompt memoization and adaptive output slot reservation are landed; provider-gated cache stability remains.                                                                                                                                            |
